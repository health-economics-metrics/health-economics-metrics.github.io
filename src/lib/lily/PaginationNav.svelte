<!-- Vendored from Lily Design System: lily-design-system-svelte-headless/components/PaginationNav/PaginationNav.svelte
...
<nav
    class={`pagination-nav ${className}`}
    aria-label={label}
    {...restProps}
>
    {@render children?.()}
