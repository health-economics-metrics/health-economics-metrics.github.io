<!-- Vendored from Lily Design System: lily-design-system-svelte-headless/components/ContentsListItem/ContentsListItem.svelte
...
<script lang="ts">
    ...
    let {
        ...
        /** List item content (typically a link or text) */
        children: Snippet;
